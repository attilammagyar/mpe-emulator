...
bool Widget::notify_mouse_wheel(Widget* widget, double const delta, bool const modifier)
{
...
GUI::Image Widget::copy_image_region(
    ...
    return mpe_emulator_widget_copy_image_region(source, left, top, width, height);
}
