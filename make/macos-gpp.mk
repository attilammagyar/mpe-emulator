...
FST_ROOT_DIR = $(FST_DIR)/mpe-emulator.vst
...
VST3_ROOT_DIR = $(VST3_DIR)/mpe-emulator.vst3
...
VST3 = $(VST3_BIN_DIR)/mpe-emulator
...
$(OBJ_TARGET_GUI_EXTRA): \
	...
	$(COMPILE_TARGET) $(OBJECTIVE_CPP) \
		-D MPE_EMULATOR_OBJC_CLASS_NAME_INFIX=Playground -c -o $@ $<
...
$(OBJ_TARGET_GUI_FST_EXTRA): \
		...
		$(FST_DIRS)
	$(COMPILE_TARGET) $(OBJECTIVE_CPP) \
		-D MPE_EMULATOR_OBJC_CLASS_NAME_INFIX=FST -c -o $@ $<
...
$(OBJ_TARGET_GUI_VST3_EXTRA): \
		...
		$(VST3_DIRS)
	$(COMPILE_TARGET) $(OBJECTIVE_CPP) \
		-D MPE_EMULATOR_OBJC_CLASS_NAME_INFIX=VST3 -c -o $@ $<
